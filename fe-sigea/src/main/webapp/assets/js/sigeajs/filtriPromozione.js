...
globalSelectizedProvicia = $('#provincia').selectize({
        ...
        onItemAdd: function(value) {
        	globalSelectizedProvicia[0].selectize.close();
        },
        onItemRemove: function () {
        	globalSelectizedProvicia[0].selectize.close();
        }
	...
	var dataTab = $('#t_eventi').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
            	...
            	if(jsondatatable && pageidmenu == 'filtriPromozione.jsp'){

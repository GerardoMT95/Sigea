...
<div style="padding: 20px 10px 10px 0px; height: auto">
	<div class="dms-breadcrumb">
		<a href="promozione" title="Promozione eventi" style="color: #000000;">Promozione eventi</a> > <span id="breadcrumbs">Ricevute eventi
			finanziati</span>
	</div>
	<div>
...
<div class="box user" id="filtroboxuser" style="margin-bottom: 30px;">
	...
	<div class="row">
		<div class="col-md-12" id="bloccorevisioniPro">
			<table id="t_eventifinanziatiPro" class="table table-striped table-bordered tabricevute" style="width: 100%; max-width: 1060px !important; overflow: hidden"></table>
		</div>
	</div>
</div>
<div class="modal esitoArrivo" tabindex="-1" role="dialog" id="modalRevisioni" data-keyboard="false">
	<div class="modal-dialog" role="document" style="width: 1140px; top: 5%; margin: auto; width: -moz-fit-content">
		<div class="modal-content modal-lg-mes" id="datiBando" style="font-size: 14px !important">
			...
			<div class="modal-body" style="font-size: 16px; text-align: left; line-height: 28px; float: left;">
...
<script type="text/javascript" src="${contextPath}/assets/js/sigeajs/ricevutePro.js"></script>
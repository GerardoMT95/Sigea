...
<div class="row" style="margin-left: 0px; padding-top:15px; margin-bottom: 15px;">
	...
	<div class="col-md-3 Input" id="aggiungiDocumento">
			<button type="button" class="btn btn-primary" data-bindingonload data-addbutton="documentoSetAggiunto" data-counter="-1" data-ph="_PH_" data-feeder="documentoSetAggiuntoLoad" ><spring:message code="label.media.carica"/></button>
	</div>
</div>
			...
			<div class="tab-content" id="myVIPdcContent">
				...
				<div class="col-md-6 Input">
					<div class="boxInput" style="margin-bottom: 0px;">
						...
						<div class="scegliere"><spring:message code="label.media.nomefile"/></div>
					</div>
				</div>

...
<!-- 	<div class="dms-breadcrumb">
	...
	<div>
		<h4 class="box-title" style="font-size: 24px; line-height: 26px; padding-left: 0px">
			<span><strong>Promozione eventi e attivit&agrave;</strong></span>
		</h4>
		<div class="row" style="margin-bottom: 0px;margin: 0px -20px;">
			...
			<div class="col-md-10" style="padding: 36px 20px;">
...
<div class="box user withmenu" id="filtroboxuser" style="margin-bottom: 30px;">
	<h4 class="box-title" style="font-size: 24px; line-height: 26px; padding-left: 0px">
						...
						<div class="tab-content" id="myTabFEContent" style="padding-top: 10px; background: transparent; min-height: 200px; margin-bottom: 0px;">
							<div class="tab-pane fade active in" id="campiFiltroEvento">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 Input  inputicondata">
									...
									<div class="boxInput">
										<input type="search" autocomplete="off" class="form-control-date Input-text start-d data" name="dataDa" readonly id="dataDal"
											placeholder="${phData}">
										<div class="scegliere">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 Input  inputicondata">
									<spring:message code="placeholder.seldata" var="phData" />
									<div class="boxInput">
										<input type="search" autocomplete="off" class="form-control-date Input-text end-d data" name="dataA" readonly id="dataAl"
											placeholder="${phData}">
										<div class="scegliere">
...
<script type="text/javascript" src="${contextPath}/assets/js/sigeajs/filtriPromozione.js"></script>
...
<c:set var="contextPath" value="${pageContext.request.contextPath}" /><div style="padding: 20px 10px 10px 0px; height: auto">
	<div class="dms-breadcrumb">
		<a href="home" title="Gestione eventi" style="color: #000000;">Gestione eventi</a> > <span id="breadcrumbs">Validazione eventi</span>
	</div>
	<div>
		<h4 class="box-title" style="font-size: 24px; line-height: 26px; padding-left: 0px">
			<span><strong>Validazione eventi</strong></span>
		</h4>
		<div class="row" style="margin-bottom: 0px;">
			<div class="col-md-2" style="text-align: center; padding: 20px;">
				<img src="${contextPath}/assets/svg/validazione.svg" style="width: 120px;">
			</div>
			<div class="col-md-10" style="padding: 20px; margin: 3% 0px;">
				<div class="accordion-content">
					<spring:message code="label.gestioneeventovalidazione.accordioncontent" />
				</div>
			</div>
		</div>
	</div>
...
<div class="box user" id="filtroboxuser" style="margin-bottom: 30px;">
	...
	<div class="accordionF">
		...
		<div class="accordionF-content" style="background-color: #F2F2F2;">
			...
			<ul class="nav nav-tabs" id="tabFilter" role="tablist" style="margin-bottom: 15px;">
				...
				<li class="nav-item" style="cursor: pointer"><a href="#campiFiltroArea" role="tab" data-toggle="tab" class="nav-link" style="cursor: pointer">Luogo</a>
				</li>
	...
	<div class="row">
		<div class="col-md-12">
			<table id="t_eventi" class="table table-striped table-bordered tabvalidazione" style="width: 100%; max-width: 1050px !important; overflow: hidden"></table>
		</div>
	</div>
</div>
<script type="text/javascript" src="${contextPath}/assets/js/sigeajs/filtriGestioneValidazione.js"></script>